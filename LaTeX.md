...
unter Windows, unter Linux und unter MacOS
...
Ich empfehle die Verwendung von miktex (Distribution) zusammen mit texniccenter (Editor).

Alternativen sind die Distribution TeX Live (Distribution) und die Editoren texstudio  oder texworks. Alle sind natürlich frei miteinander kombinierbar …
